...
- `compile_progs.sh` compiles both the CSFs and experiments, runs the experiments and prints the results to termial. Results are also written to `data/`.
...
- `functions/` contain a mix of Delilah and Rogers CSFs. Not all CSFs are used in the experiments.
